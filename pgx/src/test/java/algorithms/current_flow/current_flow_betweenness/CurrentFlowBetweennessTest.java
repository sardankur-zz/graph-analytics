...
import algorithms.current_flow.current_flow_closeness.CurrentFlowCloseness;
...
public class CurrentFlowBetweennessTest extends AlgorithmTest {
    ...
    public void testCurrentFlowCloseness() throws InterruptedException, ExecutionException {
        ...
        VertexProperty<Integer, Double> betweenness =
                algorithm.currentFlowBetweenness(pgm,
                        algorithm.getDataWithCost("src/test/java/data/sample_data4.adj", propName),
                        propName);
